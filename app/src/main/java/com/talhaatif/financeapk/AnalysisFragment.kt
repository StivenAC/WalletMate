...
class AnalysisFragment : Fragment() {
    ...
    private fun fetchTransactionsAndSetupPieChart() {
        ...
        db.collection("budget")
            ...
            .addOnFailureListener { exception ->
                Log.w("AnalysisFragment", "Error al obtener el presupuesto: ", exception)
            }
    }
    ...
    private fun setupPieChart(entries: List<PieEntry>) {
        ...
        binding.pieChart.invalidate() // recargar
    }
    ...
    private fun fetchTransactionsAndSetupPieChart(selectedDate: String) {
        ...
        db.collection("transactions")
            ...
            .addOnFailureListener { exception ->
                Log.w("AnalysisFragment", "Error al obtener los datos del presupuesto: ", exception)
