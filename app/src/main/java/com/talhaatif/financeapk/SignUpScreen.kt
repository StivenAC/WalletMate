...
class SignUpScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val currencies = listOf("USD", "EUR", "PKR", "INR", "COP")
        ...
        binding.currencySelector.setText("COP", false) // `false` to avoid triggering filtering
        ...
        viewModel.errorMessage.observe(this, Observer { message ->
            progressDialog.dismiss()
            Toast.makeText(this, "Error al ${viewModel.errorMessage.value}", Toast.LENGTH_SHORT).show()
        })
